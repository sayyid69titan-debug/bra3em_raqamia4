...
[['1', 'يفهم المفهوم', g.units[0]?.name || g.hero], ['2', 'يشاهد الشرح المصوّر', 'كل وحدة أصبحت صورة تعليمية مستقلة .'], ['3', 'يجرب النشاط أو اللعبة', g.games[0]?.[1] || 'نشاط تفاعلي'], ['4', 'يحصل على إنجاز واضح', 'يُحفظ التقدم فعليًا في قاعدة بيانات ويظهر في الصفحة الرئيسية.']].forEach(([n, title, text]) => {
  const article = document.createElement('article');
...
liveBox.innerHTML = `<div class="container"><div class="glass card grade-live-progress"><div><span class="pill">متابعة فعلية</span><h3>تقدم هذا الصف محفوظ  </h3><p id="gradeProgressText">جارٍ تحميل التقدم...</p></div><div class="progress-bar large"><span id="gradeProgressBar" style="width:0%"></span></div></div></div>`;
