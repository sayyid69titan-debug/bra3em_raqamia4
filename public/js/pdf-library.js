const STATIC_PDFS = [
   ['الصف الأول.pdf', 'grade1.pdf'],
  ['الصف الثاني.pdf', 'grade2.pdf'],
  ['الصف الثالث.pdf', 'grade3.pdf'],
  ['الصف الرابع.pdf', 'grade4.pdf'],
  ['الصف الخامس.pdf', 'grade5.pdf'],
  ['الصف السادس.pdf', 'grade6.pdf']
];
